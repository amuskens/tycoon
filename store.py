...
class Store():
    def __init__(self,parent,inventory,database):
        ...
        self.rad1 = Radiobutton(self.subFrame,text='Radio Communications Towers and Structures',variable=self.v,value='tower',anchor='w')
        self.rad1.pack(side='top',fill='x',padx=20)
        self.rad1.select()
        self.rad2 = Radiobutton(self.subFrame,text='Buildings and Data Centers',variable=self.v,value='building',anchor='w')
        self.rad2.pack(side='top',fill='x',padx=20)
        self.rad3 = Radiobutton(self.subFrame,text='Switches, Routers, Multiplexers, and Mobile Base Stations',variable=self.v,value='router',anchor='w')
